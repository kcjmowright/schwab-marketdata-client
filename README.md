...
<dependency>
  ...
  <artifactId>schwab-marketdata-client</artifactId>
...
```groovy
compile "com.kcjmowright.schwab:schwab-marketdata-client:0.0.1"
```
...
* `target/schwab-marketdata-client-0.0.1.jar`
* `target/lib/*.jar`
